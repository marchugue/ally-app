...
export default function IdScanFrontScreen() {
  ...
  const handleCapture = async () => {
    ...
    try {
      ...
      console.warn("[IdScanFront] capture error:", err);
  ...
  const handleUploadFromGallery = async () => {
    try {
      ...
      console.warn("[IdScanFront] gallery error:", err);
    }
  };
  ...
  const handleUseThis = () => {
    // Return to the Student Verification page with the captured URI and transition to Back side
    router.replace({
      pathname: "/pages/id-upload" as any,
      params: {
        ...params,
        frontUri: capturedUri,
        step: "back",
      },
    });
  };
    ...
    return (
      <View style={[styles.permRoot, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
        ...
        <Text style={styles.permBody}>
          Grant camera access to scan your Student ID, or use the Upload option instead.
        </Text>
      ...
      <View style={styles.root}>
        ...
        <View style={[styles.topBarPreview, { paddingTop: insets.top + 8 }]}>
          <View style={styles.topBarRow}>
            ...
            <Text style={styles.topBarTitle}>Front of ID</Text>
          ...
          <Text style={styles.topReminderText}>
            Check your image. Make sure text and photo are clearly visible.
          </Text>
        </View>
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={[styles.topBar, { paddingTop: insets.top + 8 }]}>
        ...
        <Text style={styles.topBarTitle}>Scan Front of ID</Text>
        <View style={{ width: 44 }} />
      </View>

      {/* Overlay: 4 dark strips around the clear guide rect */}
      {/* Top strip */}
